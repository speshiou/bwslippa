...
(function ($) {
	...
	$.fn.autotext = function (options, optionName) {
	...
	Autocomplete.prototype = {
		...
		suggest: function () {
			...
			for (i = 0; i < len; i++) {
				...
				div = $((me.selectedIndex === i ? '<div class="selected"' : '<div') + ' title="' + s + '">' + (this.data[i].isItem ? '<div class="item">' : '<div class="customer">') + f(s, this.data[i], v) + '</div></div>');
